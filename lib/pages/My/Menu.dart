...
class Menu extends StatelessWidget {
    ...
    Widget _menuItem (String name, String url, double width, double height) {
        return Column(
            children: <Widget>[
                Container(
        ...
        return Container(
            ...
            child: Row(
                children: <Widget>[
                    Expanded(
                        flex: 1,
                        child: this._menuItem("我的神木", "images/wodeshenmu.png", 44, 61)
                    ),
                    Expanded(
                        flex: 1,
                        child: this._menuItem("我的钱包", "images/wodeqianbao.png", 57, 61)
                    ),
                    Expanded(
                        flex: 1,
                        child: this._menuItem("我的动态", "images/wodedongtai.png", 54, 57)
                    )
                ]
            )
        );
